...
```{r graf, fig.align='center', fig.cap='Povezava med številom točk in asistenc'}
...
```{r graf, fig.align='center', fig.cap='Povezava med številom točk, asistenc in skokov glede na državo'}
